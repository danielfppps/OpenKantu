...
begin
    ...
    begin
     ...
     while (checkedInList(randomPattern.tradingRules[i][IDX_SECOND_INDICATOR])=false) do  randomPattern.tradingRules[i][IDX_SECOND_INDICATOR] := RandomRange(0, numberOfIndicators);
