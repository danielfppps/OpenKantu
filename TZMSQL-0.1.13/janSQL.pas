...
uses
    LCLIntf,  SysUtils, Classes, Graphics, Controls, Forms,Dialogs,janSQLstrings,janSQLExpression2,janSQLTokenizer, mwStringHashList
...
begin
  ...
  DecimalSeparator:=SysUtils.DefaultFormatSettings.DecimalSeparator; //Changed by Z. Matić, 05.02.2012
