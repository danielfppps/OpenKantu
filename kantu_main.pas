...
begin
  ...
  configFile := TStringList.Create;
   ...
   configFile.Add(BoolToStr(SimulationForm.UseTimeExit.Checked));
...
begin
       ...
       2 : typeString1 := 'Low';
       3 : typeString1 := 'Close';
       4 : typeString1 := 'MathAbs(Open' +'[' + firstShift + ']- Close' +'[' + firstShift + '])' ;
       5 : typeString1 := 'MathAbs(High' +'[' + firstShift + ']- Low' +'[' + firstShift + '])' ;
       else typeString1 := 'Input'+ FloatToStr(pricePattern.tradingRules[j][IDX_FIRST_INDICATOR]-2);
       end;
       ...
       2 : typeString2 := 'Low';
       3 : typeString2 := 'Close';
       4 : typeString2 := 'MathAbs(Open' +'[' + secondShift + ']- Close' +'[' + secondShift + '])' ;
       5 : typeString2 := 'MathAbs(High' +'[' + secondShift + ']- Low' +'[' + secondShift + '])' ;
       else typeString2 := 'Input'+ FloatToStr(pricePattern.tradingRules[j][IDX_SECOND_INDICATOR]-2);
       end;
